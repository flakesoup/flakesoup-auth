...
//        }
//        OAuth2User customUserDetails = buildCustomUserDetails(username, password, userId, clientId);
//        return new CustomAuthenticationToken(customUserDetails);
//    }
//
//    private OAuth2User buildCustomUserDetails(String username, String password, String userId, String clientId) {
//        OAuth2User customUserDetails = new OAuth2User();
//                .withUserId(userId)
