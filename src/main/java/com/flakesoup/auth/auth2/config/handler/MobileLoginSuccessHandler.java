package com.flakesoup.auth.auth2.config.handler;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.CharsetUtil;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.flakesoup.auth.auth2.config.OAuth2Utils;
...
public class MobileLoginSuccessHandler implements AuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
		...
		try {
			String[] tokens = OAuth2Utils.extractAndDecodeHeader(header);
